...
type LogConfig struct {
	...
	// MaxBatchSize enables and defines the maximum size in bytes for a batched request of log entries
	// An unset value disables batching, while 0 defaults to the Cloud Logging API's maximum request size (10 MB)
